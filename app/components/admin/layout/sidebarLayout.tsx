...
export default function SidebarLayout() {
  ...
  return (
    <>
      <div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full lg:h-screen flex-col justify-between hidden sm:flex">
          ...
          <ul className="mt-12 justify-center">
            {navigation.map((item) => (
              <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                ...
                >
                  <item.icon className="icon icon-tabler icon-tabler-grid" />

                  <span className="text-sm mr-2">{item.name}</span>
                </ActiveLink>

                <div className="py-1 px-3 bg-gray-600 rounded text-gray-300 text-xs">
                  5
                </div>
              </li>
            ))}

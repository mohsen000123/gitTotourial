        ...
        <div className=" px-8">
          ...
          <div className="flex justify-center mt-48 mb-4 w-full">
            <div className="relative">
              ...
              <input
                className="bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-gray-300 placeholder-gray-400 bg-gray-100 pr-20 py-2"
                type="text"
                placeholder="Search"
              />
            </div>

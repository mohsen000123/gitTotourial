export default function SidebarMoblieLayout() {
  return (
    <>
      <div
      ...
      >
        <button
          ...
          id="openSideBar"
          className="h-10 w-10 bg-gray-800 absolute left-0 mt-16 -ml-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800"
        >
          <svg
        ...
        <button
          ...
          id="closeSideBar"
          className="hidden h-10 w-10 bg-gray-800 absolute right-0 mt-16 -ml-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="px-8">
          ...
          <ul className="mt-12">
            <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
              ...
              >
                ...
                <span className="text-sm mr-2">Dashboard</span>
              </a>
            ...
            <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
              ...
              >
                ...
                <span className="text-sm mr-2">Deliverables</span>
              </a>
            </li>
            <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
              <a
              ...
              >
                ...
                <span className="text-sm mr-2">Invoices</span>
              </a>
              <div className="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">
                25
              </div>
            ...
            <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
              ...
              >
                ...
                <span className="text-sm mr-2">Inventory</span>
              </a>
            </li>
          ...
          <div className="flex justify-center mt-48 mb-4 w-full">
            <div className="relative">
              <div className="text-gray-300 absolute mr-4 inset-0 m-auto w-4 h-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
